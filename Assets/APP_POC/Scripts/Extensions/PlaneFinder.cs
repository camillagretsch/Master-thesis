...
/// <summary>
/// Struct to define the orientation and bounds of a plane.
/// </summary>
...
/// <summary>
/// Struct to define a bounded plane.
/// </summary>
...
public class PlaneFinder
{
    ...
    /// </param>
    public static BoundedPlane[] FindBoundedPlanes(List<MeshData> meshes, float snapToGravityThreshold = 0.0f, float minArea = 0.0f)
    {
        StartPlaneFinding();
    ...
    /// logic.
    /// </param>
    public static BoundedPlane[] FindBoundedSubPlanes(List<MeshData> meshes, float snapToGravityThreshold = 0.0f)
    {
        StartPlaneFinding();
    ...
    /// triangles have a total area less than this threshold are ignored.
    /// </param>
    public static BoundedPlane[] MergeBoundedSubPlanes(BoundedPlane[] subPlanes, float snapToGravityThreshold = 0.0f, float minArea = 0.0f)
    {
        StartPlaneFinding();
